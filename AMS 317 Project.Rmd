...
#The points in the middle appear align closely with the line, while points at the tails show more deviation. This indicates that while the central part of the residuals is approximately normal, the extreme values still show skewness. However, it is still close enough to showing a linear association which supports the use of ANOVA. 
